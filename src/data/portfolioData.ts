...
export const experiencesData: Experience[] = [
  {
    ...
    "company": {
      ...
      "sectors": ["E-commerce", "Industrie", "Ressources humaines", "Événementiel"],
      "location": "France",
      "website": ""
    },
    "projects": [
      {
        ...
        "period": { "start_date": "2017-01-01", "end_date": "2017-06-30" },
        ...
        "tech_stack": ["Python", "BeautifulSoup", "AWS Lambda", "AWS S3", "Docker", "Keras", "TensorFlow", "Scikit-learn", "Matplotlib", "Jupyter Notebook", "AWS EC2", "Jenkins"],
      ...
      },
      {
        ...
        "period": { "start_date": "2017-04-01", "end_date": "2017-12-31" },
        ...
        "tech_stack": ["Python", "PostgreSQL", "AWS RDS", "Alembic", "Docker", "Twitter API", "Facebook API", "Discord API"],
    ...
    "projects": [
      {
        ...
        "period": { "start_date": "2018-01-01", "end_date": "2022-12-31" },
        ...
        "tech_stack": ["Python", "BERT", "GPT", "HuggingFace", "AWS SageMaker", "AWS S3", "Docker", "AWS Lambda", "PostgreSQL"],
        ...
        "links": [{ "type": "article", "label": "Article AWS France sur le pipeline SageMaker", "url": "" }]
      },
      {
        "name": "Communication & retour d'expérience AWS",
        "period": { "start_date": "2020-01-01", "end_date": "2022-12-31" },
  ...
  },
  {
    ...
    "company": {
      ...
      "sectors": ["Achat groupé", "Data", "Business Intelligence", "Intelligence Artificielle", "Chatbots"],
      "location": "France",
      "website": ""
    },
    "projects": [
      {
        ...
        "period": { "start_date": "2022-01-01", "end_date": "2023-12-31" },
      ...
      },
      {
        ...
        "period": { "start_date": "2022-03-01", "end_date": "2023-06-30" },
      ...
      },
      {
        ...
        "period": { "start_date": "2022-04-01", "end_date": "2023-12-31" },
      ...
      },
      {
        ...
        "period": { "start_date": "2022-06-01", "end_date": "2023-09-30" },
  ...
  },
  {
    ...
    "company": {
      ...
      "sectors": ["Fintech", "Paiements internationaux", "GenAI", "Automatisation"],
      "location": "France",
      "website": ""
    },
    "projects": [
      {
        ...
        "tech_stack": ["AWS Textract", "OpenAI", "LangChain", "Pydantic-AI", "DeepEval", "Scikit-learn", "Python"],
      ...
      },
      {
        ...
        "period": { "start_date": "2024-04-01", "end_date": null },
        ...
        "tech_stack": ["Kafka", "FastAPI", "AWS S3", "Python", "asyncio", "REST"],
      ...
      },
      {
        ...
        "tech_stack": ["Kubernetes", "Cilium", "Docker", "GitHub Actions", "ArgoCD", "Grafana", "Prometheus", "OpenTelemetry"],
      ...
      },
      {
        ...
        "period": { "start_date": "2024-01-01", "end_date": null },
        ...
        "tech_stack": ["Agilité", "Management technique", "Revue de code", "Architecture"],
    ...
    "projects": [
      {
        ...
        "period": { "start_date": "2023-01-01", "end_date": null },
        ...
        "tech_stack": ["OCR", "Pydantic-AI", "Python", "FastAPI", "AWS EC2", "AWS S3"],
      ...
      },
      {
        ...
        "period": { "start_date": "2023-03-01", "end_date": null },
      ...
      },
      {
        ...
        "period": { "start_date": "2023-02-01", "end_date": null },
      ...
      },
      {
        ...
        "period": { "start_date": "2023-06-01", "end_date": null },
      ...
      },
      {
        ...
        "tech_stack": ["Stratégie produit", "Business model", "Prospection commerciale", "Démonstration produit"],
        "impact": "Positionnement clair du produit sur le marché LegalTech et validation du besoin auprès des premiers clients.",
        "links": [{ "type": "award", "label": "Lauréat du concours TechnoDroit 2024", "url": "" }]
      }
    ]
  }
];
...
export const educationData: Education[] = [
  {
    "id": "licence-maths-informatique-lyon1",
    "degree": "Licence",
    "field_of_study": "Mathématiques et Informatique",
    "start_date": "2013-09-01",
    "end_date": "2016-06-30",
    "grade": null,
    "summary": "Formation en mathématiques et informatique couvrant la théorie de l'informatique, la calculabilité, le développement en C, l'algèbre linéaire et l'analyse.",
    "location": "Lyon, France",
    "institution": {
      "name": "Université Claude Bernard Lyon 1",
      "description": "Université spécialisée dans les sciences, les technologies et la santé.",
      "location": "Lyon, France",
      "website": ""
    },
    "projects": []
  ...
  {
    "id": "master-datascience-lyon1",
    "degree": "Master",
    "field_of_study": "Data Science",
    "start_date": "2016-09-01",
    "end_date": "2018-06-30",
    "grade": null,
    "summary": "Master orienté data science avec un focus sur les probabilités appliquées, le data mining, le machine learning et le développement Python.",
    "location": "Lyon, France",
    "institution": {
      "name": "Université Claude Bernard Lyon 1",
      "description": "Université spécialisée dans les sciences, les technologies et la santé.",
